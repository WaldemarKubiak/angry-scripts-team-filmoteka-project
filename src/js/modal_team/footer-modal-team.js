import Waldemar from '/src/images/modal_team/Waldemar.svg';
import Lukasz from '/src/images/modal_team/Lukasz.svg';
import Emilia from '/src/images/modal_team/Emilia.svg';
import Piotrek from '/src/images/modal_team/Piotrek.svg';
import Karolina from '/src/images/modal_team/Karolina.svg';
import Krzysztof from '/src/images/modal_team/Krzysztof.svg';
import Mateusz from '/src/images/modal_team/Mateusz.svg';
import Lucas from '/src/images/modal_team/Lucas.svg';

export const teamIds = [
  {
    name: 'Waldemar Kubiak',
    position: 'Team Lead',
    img: Waldemar ,
  ...
  },
  {
    ...
    {
      name: 'Łukasz Marchliński',
      position: 'Developer',
      img: Lucas,
      github: 'https://github.com/LukaszMarchlinski',
      linkedin: 'https://linkedin.com/in/lukaszmarchlinski',
      text: '”_ C sprawia, że łatwo jest sobie strzelić w stopę. Z C++ jest to trudniejsze, ale za to w razie czego odstrzelisz sobie całą nogę _”. – Bjarne Stroustrup',
    },
];